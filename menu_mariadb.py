import pymysql
from funciones_mariadb import Conexion_BD, desconectar, listar_informacion, buscar_informacion, buscar_informacion_relacionada, insertar_informacion, borrar_informacion, actualizar_informacion
